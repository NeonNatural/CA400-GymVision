...
class Ui(object):
    def setupUi(self,homeScreen):
        ...
        self.registerBtn = QPushButton("Create account",Widget)
        ...
        self.registerBtn.clicked.connect(lambda: self.mylogin.createAcc(self.username.text(),self.password.text(),homeScreen) )
        return Widget
